  ...
  const capabilities = [
    {
      ...
      description: "Precision electronics for defence applications and strategic systems.",
    },
    {
      icon: Crosshair,
      title: "Simulators & Training",
      description: "Advanced training simulators for armed forces and industrial use.",
    },
    {
      icon: Cpu,
      title: "Industrial Automation",
      description: "PLC-based automation systems for manufacturing excellence.",
    },
    {
      icon: Zap,
      title: "Power & Energy Systems",
      description: "Custom power distribution and control panel solutions.",
    },
    {
      icon: Settings,
      title: "Data Acquisition",
      description: "High-precision data acquisition and monitoring systems.",
    },
    {
      icon: Factory,
      title: "Custom Electronics",
      description: "Bespoke electronic systems tailored to specific requirements.",
    },
  ];
  ...
  return (
    <section id="capabilities" className="section-padding bg-background">
      <div className="container-width">
        ...
        {/* Capabilities Grid - Icon Based Cards */}
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {capabilities.map((item) => (
            <div
              key={item.title}
              className="card-defence p-8 group cursor-pointer"
            >
