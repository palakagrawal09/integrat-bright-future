  ...
  const gemProducts = [
    {
      ...
      description: "High-performance lithium battery packs for defence and industrial applications, available in various configurations.",
      category: "Power Systems",
    },
    {
      name: "Control Units & Panels",
      description: "Custom control units and automation panels for industrial and defence-grade operations.",
      category: "Control Systems",
    },
    {
      name: "Power Modules",
      description: "Rugged power distribution and regulation modules designed for field and factory environments.",
      category: "Power Systems",
    },
    {
      name: "Data Acquisition Systems",
      description: "PC-based and embedded data acquisition systems for monitoring and recording industrial parameters.",
      category: "Instrumentation",
    },
    {
      name: "Signal Conditioning Equipment",
      description: "Precision signal conditioning modules for accurate sensor data processing.",
      category: "Instrumentation",
    },
    {
      name: "Temperature Controllers",
      description: "Industrial temperature monitoring and control units with high accuracy and reliability.",
      category: "Control Systems",
    },
  ];
          ...
          <div className="container-width px-4">
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                DIPL is a registered seller on the Government e-Marketplace (GeM). 
                Browse our listed products available for direct procurement by government organizations.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container-width">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground mt-3 max-w-2xl mx-auto leading-relaxed">
                Listed on GeM for transparent and efficient government procurement.
              </p>
            </div>
          ...
          <div className="container-width">
            <div className="p-8 sm:p-12 text-center bg-defence-green">
              ...
              <p className="text-white/80 mb-6 max-w-xl mx-auto leading-relaxed">
                Visit our seller profile on the Government e-Marketplace for direct procurement and transparent pricing.
              </p>
              <a
